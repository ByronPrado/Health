...
@dso_cache = dso_local local_unnamed_addr global [492 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 8770493082613993, ; hash 0x1f28b78cb1b8e9, from name: libaot-Xamarin.AndroidX.Health.Connect.ConnectClient
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-Xamarin.AndroidX.Health.Connect.ConnectClient.dll.so
	...
	%struct.DSOCacheEntry {
		i64 80503604462390124, ; hash 0x11e019a0b1e8b6c, from name: aot-Health.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Health.dll.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4286090698113355327, ; hash 0x3b7b40c800270e3f, from name: aot-Health
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Health.dll.so
		ptr null; void* handle (0x0)
	}, ; 112
	...
	%struct.DSOCacheEntry {
		i64 6870206099759269128, ; hash 0x5f57e00c3ddf8508, from name: aot-Xamarin.AndroidX.Health.Connect.ConnectClient.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-Xamarin.AndroidX.Health.Connect.ConnectClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 157
	...
	%struct.DSOCacheEntry {
		i64 7339464000651670673, ; hash 0x65db039f589c3491, from name: Health
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Health.dll.so
		ptr null; void* handle (0x0)
	}, ; 171
	...
	%struct.DSOCacheEntry {
		i64 7868394457821160741, ; hash 0x6d32271223152525, from name: libaot-Health
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Health.dll.so
		ptr null; void* handle (0x0)
	}, ; 193
	...
	%struct.DSOCacheEntry {
		i64 12558784869138724492, ; hash 0xae49c44c9790768c, from name: Xamarin.AndroidX.Health.Connect.ConnectClient
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-Xamarin.AndroidX.Health.Connect.ConnectClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 330
	...
	%struct.DSOCacheEntry {
		i64 13543514781350111216, ; hash 0xbbf43aefe0a027f0, from name: aot-Xamarin.AndroidX.Health.Connect.ConnectClient
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-Xamarin.AndroidX.Health.Connect.ConnectClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 360
	...
	%struct.DSOCacheEntry {
		i64 13603146073336204458, ; hash 0xbcc81547f8f44caa, from name: Xamarin.AndroidX.Health.Connect.ConnectClient.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-Xamarin.AndroidX.Health.Connect.ConnectClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 363
	%struct.DSOCacheEntry {
		i64 13647807868712263767, ; hash 0xbd66c0f289602057, from name: libaot-Health.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Health.dll.so
		ptr null; void* handle (0x0)
	}, ; 364
	...
	%struct.DSOCacheEntry {
		i64 14399044924527954052, ; hash 0xc7d3af11c7614884, from name: Health.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Health.dll.so
		ptr null; void* handle (0x0)
	}, ; 391
	...
	%struct.DSOCacheEntry {
		i64 15316613168057149017, ; hash 0xd48f8a86841de659, from name: libaot-Xamarin.AndroidX.Health.Connect.ConnectClient.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-Xamarin.AndroidX.Health.Connect.ConnectClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 409
...
@.env.3 = private unnamed_addr constant [37 x i8] c"61aa926e-2c14-4a63-b3ae-322e00b059e4\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [21 x i8] c"libaot-Health.dll.so\00", align 1
...
@.DSOCacheEntry.32_name = private unnamed_addr constant [60 x i8] c"libaot-Xamarin.AndroidX.Health.Connect.ConnectClient.dll.so\00", align 1
