...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Health.Platforms.Android.Callbacks.Continuation, Health", Continuation.class, __md_methods);
	}
	...
	public Continuation ()
	{
		...
		if (getClass () == Continuation.class) {
			mono.android.TypeManager.Activate ("Health.Platforms.Android.Callbacks.Continuation, Health", "", this, new java.lang.Object[] {  });
		}
	}
